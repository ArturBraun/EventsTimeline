        ...
        <li className="mb-10 ml-6">
            ...
            : 
                <div className="overflow-hidden bg-white shadow sm:rounded-lg">
                    ...
                    <div onClick={() => setDetailed(!detailed)} className="cursor-pointer border-t border-gray-200">
                        <dl>
                                ...
                                event.type_id ? 
                                    <div className="bg-white px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                        ...
                                        <dd className="mt-1 text-sm text-gray-900 flex">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill={event.type.color} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
